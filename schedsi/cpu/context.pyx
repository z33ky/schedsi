...
class Chain:
    ...
    def set_timer(self, timeout, int idx=-1):
    ...
    def elapse(self, time):
        ...
        cdef bint elapsed = self.next_timeout <= 0
    ...
    def run_background_all(self, current_time, time, int end=-1):
    ...
    def run_background_other(self, current_time, time):
        ...
        cdef int end = next((-i for i, c in enumerate(reversed(self.contexts))
